...
INSERT INTO `user` (`user_id`, `avatar`, `created_at`, `updated_at`, `name`, `password`, `password_salt`,
                    `password_type`, `phone`, `country_code`)
VALUES ('82313034-e97d-4c30-8e96-c524a772b530', '', '2024-01-04 03:25:26', '2024-01-17 05:47:08', 'admin',
        '43eec874a5751fe2f687e00ea0eedad9', 'ODdGvnwqpH', 'md5', '18888888888', 'CN');
...
VALUES (1, 'admin', '管理员', '', '2023-12-22 23:58:09', '2024-01-03 06:04:54'),
...
/*!40000 ALTER TABLE `admin_menu_role`
  DISABLE KEYS */;

INSERT INTO `admin_menu_role` (`id`, `createdAt`, `menuId`, `roleId`)
VALUES (100, '2024-01-25 10:08:46', 17, 2),
...
/*!40000 ALTER TABLE `admin_role_user`
  DISABLE KEYS */;

INSERT INTO `admin_role_user` (`id`, `createdAt`, `roleId`, `userId`)
VALUES (10, '2023-12-27 08:29:33', 2, '2f329bed-596b-4eed-a27d-0cb7f498cfe3'),
...
/*!40000 ALTER TABLE `demo_area`
  DISABLE KEYS */;

INSERT INTO `demo_area` (`id`, `createdAt`, `name`, `address`, `code`, `parentCode`)
VALUES (13, '2023-12-31 13:40:15', '北京市', '北京市', '00003', ''),
...
/*!40000 ALTER TABLE `demo_post_author`
  DISABLE KEYS */;

INSERT INTO `demo_post_author` (`id`, `createdAt`, `updatedAt`, `name`, `email`)
VALUES (1, '2024-02-19 10:31:44.000', '2024-02-19 10:31:47.000', '张三', 'zs@fireboom.io'),
...
/*!40000 ALTER TABLE `demo_post_category`
  DISABLE KEYS */;

INSERT INTO `demo_post_category` (`id`, `createdAt`, `updatedAt`, `name`, `description`)
VALUES (1, '2023-12-28 08:20:43', '2023-12-28 08:20:46', '人文风情', ''),
...
/*!40000 ALTER TABLE `demo_post`
  DISABLE KEYS */;

INSERT INTO `demo_post` (`id`, `createdAt`, `updatedAt`, `title`, `poster`, `content`, `categoryId`, `authorId`,
                         `likes`, `views`)
VALUES (2, '2023-12-27 08:22:05', '2023-12-27 08:22:10', 'test12', '',
        ...
        1, 2, 4, 6),
       (3, '2023-12-28 08:22:12', '2024-02-21 08:07:57', 'test123',
        'https://cos.ap-nanjing.myqcloud.com/test-1314985928/article/00083e4681c28efa.jpeg',
        '<p>test1 content 3<img src=\"https://cos.ap-nanjing.myqcloud.com/test-1314985928/avatar/3212/4ce450ae598faf8e.png\" alt=\"\" width=\"512\" height=\"604\"></p>',
        1, 1, 0, 0),
       (34, '2024-02-20 08:11:00', '2024-02-21 07:36:39', '什么是飞布？',
        'https://cos.ap-nanjing.myqcloud.com/test-1314985928/avatar/3212/4666cf6316dcc2a4.png',
        ...
        57, 1, 0, 0),
       (36, '2024-02-21 08:11:30', '2024-02-22 07:33:21', '飞布的价值',
        'https://cos.ap-nanjing.myqcloud.com/test-1314985928/article/588abb90c0cd8b05.png',
